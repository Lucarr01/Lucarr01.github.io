  ...
  return (
    <div className="px-6 md:px-20 lg:px-40 py-10 max-w-[1200px] mx-auto">
      ...
      <section className="liquid-glass rounded-xl p-8 mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        {/* Info Icons */}
        <div className="flex justify-center items-center pt-6 mt-6 border-t border-white/10">
          ...
          {/* Social links (no tooltips) */}
          <div className="flex gap-4">
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/luca-rippe-b93a69217" target="_blank" rel="noopener noreferrer">
              <div className="size-10 rounded-lg bg-primary/10 flex items-center justify-center hover:bg-primary/20 transition-colors">
            ...
            {/* GitHub */}
            <a href="https://github.com/Lucarr01" target="_blank" rel="noopener noreferrer">
              <div className="size-10 rounded-lg bg-primary/10 flex items-center justify-center hover:bg-primary/20 transition-colors">
                <svg className="size-5 fill-primary" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
